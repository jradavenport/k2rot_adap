...
This age map may be used to infer the age distribution of stars across and
between K2 fields.

{\tt chronometer} extends isochrone fitting by simultaneously fitting an
age-rotation relation and a age-velocity dispersion relation.
