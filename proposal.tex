...
Observable differences in these 2 scenarios:
1. bimodality would be seen only locally, once we get out far enough to sample other SFHs it should disappear. 
2. bimodality would be seen everywhere, indicating this truly is a transition point in the spin-down model at young ages
