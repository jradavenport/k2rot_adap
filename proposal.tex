...
% Unlike the other two pipelines, \ktwosc\ light curves are designed to preserve slow stellar variability where possible.
...
%Previous observing of these systems by Co-I Angus established that around 80\% of the \citet{Oh2016} proper motions pairs have radial
%velocities consistent with being truly comoving in space.
...
\begin{itemize}
\item {\bf Year 1:} In early 2018 we will evaluate the various K2 reduction pipelines, produce the quick-look catalog of K2 rotation periods using Lomb-Scargle and ACF methods, and begin generating the Systematics-Insensitive Periodograms. When the Gaia DR2 data is released (scheduled for April 2018), Davenport will take lead on investigating the origin of the rotation period bimodality using our preliminary rotation period catalog. 
Angus will take lead on adapting the Gaussian Process period finding approach with {\tt celerite} to the K2 data and developing Python scripts for running on the WWU computer cluster. 
...
Davenport will update his analysis of the rotation period bimodality using this final catalog.
Angus will take lead on comparing preliminary gyrochronology ages to kinematic ages using the Gaia DR2 proper motions, and will compare gyrochronology models at older stellar ages.
\\
{\bf Milestones:} Produce final catalog of rotation periods using multiple algorithms, and exploring various K2 data reduction pipelines. Davenport, assisted by Angus, will write and submit Paper 1: {\it The K2 Rotation Period Catalog}. Davenport will begin analysis and outline for publication on the period bimodality. 
...
\\
{\bf Contingencies:} If the Gaia DR2 data release is pushed back from April 2018 (e.g. to early 2019), we will begin our period bimodality analysis using the DR1 ``TGAS'' data to explore the period distribution between K2 fields at distances $\lesssim 1$ kpc.
%
