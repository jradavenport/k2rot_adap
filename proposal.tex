...
\racomment{I'm not sure we want to get into measuring rotation periods for
...
\citet{Vanderburg2015}, lightcurves, the {\tt everest} \citet{Luger2016} light
...
This method simulataneously fits light curves with a sinusoid and a noise
...
extracting periodic signals in the frequency domain \citet{Angus2017}.
...
Wherever possible we will mask out discontinous astrophysical signals, such as
