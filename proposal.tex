...
other efforts to reproduce SFH in solar neighborhood do show variation of SFH,
color-magnitude diagram inversion of the field gives peak of SFH around 3Gyr ago, with slow variations over several Gyr \citep{cignoni2006}. CMD studies from Hipparcos by \citet{hernandez2000} have also suggested a shorter timescale variation of $\sim$0.5 Gyr.
white dwarf cooling ages (cosmochronology) shows the past few Gyr has been higher SFR, but too small of sample, only get age resolution of $\sim$1 Gyr \citep{tremblay2014}
...
This will include $\sim$XXXXX stars from Campaigns 0-16.
...
and eclipses.
We will apply a flare removal algorithm to identify and remove flares.
...
Autocorrelation Function. From our sample of 252,000 available K2 targets, we
expect to recover $\sim$63,000 new rotation periods, bringing the total
\Kepler/K2 sample to $\sim$100,000.
