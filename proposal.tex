...
this periodic information from starspots also allowing investigations into ability to measure surface differential rotation \citep{aigrain2015}.

K2 data quality has demonstrated ability to measure rotation periods \citep[e.g.][]{douglas2017}

To date (through Campaign 10) K2 has produced long-cadence light curves for more than 252,000 targets, now exceding the number of stars observed by the original \Kepler mission.
